...
const products = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 168,
    image: 'https://images.unsplash.com/photo-1615526675159-e248c3021d3f?w=800&auto=format&fit=crop&q=80',
    badge: 'POPULAR',
    inStock: true,
  ...
  {
    id: 17,
    name: 'Titanium Halo Smart Health Band',
    category: 'Wearables',
    price: 18490,
    originalPrice: 22990,
    rating: 4.8,
    ...
    description: 'Medical-grade biometric sensor suite with high-contrast OLED display. Continuous body temperature, sleep stages, and real-time stress index.',
    specs: {
      'Material': 'Grade 5 Medical Titanium & Fluororubber',
      'Water Resistance': '100m Submersible (10 ATM)',
      'Battery': '14 Days on Single Charge',
      'Weight': '18.5 grams Featherweight',
      'Sensors': 'Dual PPG, Skin Temp, 3D Accelerometer, ECG',
      'Warranty': '2 Years Official'
    }
  },
  {
  ...
  {
    id: 19,
    name: 'SteamDeck Elite Pro Controller',
    category: 'Gaming',
    price: 6490,
    originalPrice: 7990,
    rating: 4.9,
    ...
    inStock: true,
    colors: ['#090d16'],
    description: 'Matte-black precision gaming controller with custom hall-effect anti-drift thumbsticks, tactile microswitch triggers, and ultra-low latency wireless.',
    specs: {
      'Connectivity': '2.4GHz Lossless + Bluetooth 5.3',
      'Thumbsticks': 'Hall Effect Magnetic Anti-Drift',
      'Triggers': 'Adjustable Hair-Trigger Stops',
      'Battery': '40 Hours Rechargeable',
      'Compatibility': 'PC, Steam, Consoles & Mobile',
      'Warranty': '2 Years Official'
    }
  },
  {
    id: 20,
    name: 'MagFlow Flagship Ecosystem Bundle',
    category: 'Accessories',
    price: 4490,
    originalPrice: 5990,
    rating: 4.8,
    ...
    description: 'Precision machined fast-charge ecosystem kit engineered to power and sync your mobile workstation simultaneously.',
    specs: {
      'MagSafe Output': '15W Fast Charge (Qi2 Certified)',
      'Compatibility': 'iOS, Android & Ultrabooks',
